...
The "http-es01.csr" file is a Certificate Signing Request.
...
In either case, you need to provide the http-es01.csr file to the certificate authority, and they will provide you with your signed certificate.
For the purposes of this document, we assume that when they send you your certificate, you will save it as a file named "http-es01.crt".
...
The "http-es01.key" file is your private key.
...
certificate. When you have a copy of the certificate you should copy it and the private key ("http-es01.key") to the config directory.
The sample config assumes that the certificate is named "http-es01.crt".
